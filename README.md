...
Our contributors - `surfer05` , `lordshashank` , `07Vaishnavi-Singh` , `me-loser`.
...
TransiFy is the protocol that provides one swap transfer of tokens from one chain to any other token. Do a search and replace with your text editor for the following: `github_username`, `Transify`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `Swap n Profit`, `Made with Router`
...
- []() The team from Router protocol was of a great help to us.
- []() A token of appreciation to Shivam Agarwal for aptly guiding us in developing in this project.
- []() A great thanks to `me-loser` for helping us with the front-end.
- []() Finally, kudos to the team for the great work `surfer05` `lordshashank` `07Vaishnavi-Singh`
