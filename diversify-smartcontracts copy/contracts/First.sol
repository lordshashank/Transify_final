...
contract MyContract is ICrossTalkApplication {
    ...
    mapping(uint64 => mapping(string => uint128)) public ratiosX1000000;
    mapping(uint64 => mapping(string => uint128)) public maxRatiosX1000000;
    ...
    function setterRatio(
        ...
        uint128 ratioX1000000
    ) public {
        require(
            ratioX1000000 <= maxRatiosX1000000[chainType][chainId],
            "incorrect ratio"
        );
        ratiosX1000000[chainType][chainId] = ratioX1000000;
    }

    // (this contract's chain coin / destination coin) x 1000000
    function setMaxRatiosX1000000(
        uint64 chainType,
        string memory chainId,
        uint128 maxRatioX1000000
    ) public {
        require(msg.sender == owner, "only owner");
        maxRatiosX1000000[chainType][chainId] = maxRatioX1000000;
    }
    ...
    function transferTokens(
        ...
        amount = msg.value;
        uint128 modifiedRatio = ratiosX1000000[chainType][chainId];
        uint tokenToBeTransferred = (amount * modifiedRatio) / 1000000;
